...
# 
package org::puremvc::perl5::multicore::utilities::statemachine::StateMachine;
...
sub registerState {
  ...
  die "Provided state is not an instance of org::puremvc::perl5::multicore::utilities::statemachine::State"
    unless ref($state) eq 'org::puremvc::perl5::multicore::utilities::statemachine::State';
...
sub transitionTo {
  ...
  die "Provided state is not an instance of org::puremvc::perl5::multicore::utilities::statemachine::State"
    unless ref($next_state) eq 'org::puremvc::perl5::multicore::utilities::statemachine::State';
...
C<< org::puremvc::perl5::multicore::utilities::statemachine::StateMachine >>
...
C<< $state - org::puremvc::perl5::multicore::utilities::statemachine::State >>
...
C<< $next_state - org::puremvc::perl5::multicore::utilities::statemachine::State >>
...
C<< $new_state - org::puremvc::perl5::multicore::utilities::statemachine::State >> - Optional

The new current L<State|State> of the C<< StateMachine >>.

B<Returns>

C<< org::puremvc::perl5::multicore::utilities::statemachine::State >> - The current L<State|State> of the C<< StateMachine >>.
...
L<org::puremvc::perl5::multicore::utilities::statemachine::FSMInjector|FSMInjector>
