package org::puremvc::perl5::multicore::utilities::statemachine::unittests::StateTest;
...
BEGIN { use_ok( 'org::puremvc::perl5::multicore::utilities::statemachine::State' ); }
require_ok( 'org::puremvc::perl5::multicore::utilities::statemachine::State' );
...
sub testConstructor {
  ...
  my $state = org::puremvc::perl5::multicore::utilities::statemachine::State->new("state1");
  ...
  $state = org::puremvc::perl5::multicore::utilities::statemachine::State->new("state1", "entering", "exiting", "changed");
