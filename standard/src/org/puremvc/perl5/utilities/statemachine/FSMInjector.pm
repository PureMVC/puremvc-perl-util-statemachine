...
# 
package org::puremvc::perl5::utilities::statemachine::FSMInjector;
...
use org::puremvc::perl5::utilities::statemachine::State;
...
sub inject {
  ...
  $self->{_facade}->registerMediator( $state_machine );
...
sub createState {
  ...
  my $state = org::puremvc::perl5::utilities::statemachine::State->new( $name, $entering, $exiting, $changed );
...
C<< org::puremvc::perl5::utilities::statemachine::FSMInjector >>
