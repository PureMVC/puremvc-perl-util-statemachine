package org::puremvc::perl5::utilities::statemachine::unittests::StateMachineTest;
...
BEGIN { use_ok( 'org::puremvc::perl5::utilities::statemachine::StateMachine' ); }
require_ok( 'org::puremvc::perl5::utilities::statemachine::StateMachine' );
...
sub testConstructor {
  ...
  my $state_machine = org::puremvc::perl5::utilities::statemachine::StateMachine->new();
  
  is(defined $state_machine, 1, 'Expecting $state_machine to be defined');
  isa_ok($state_machine, 'org::puremvc::perl5::utilities::statemachine::StateMachine');
...
sub testRegisterState {
  ...
  my $state2 = org::puremvc::perl5::utilities::statemachine::State->new("state2");
  ...
  isa_ok($state_machine->{initial}, 'org::puremvc::perl5::utilities::statemachine::State');
